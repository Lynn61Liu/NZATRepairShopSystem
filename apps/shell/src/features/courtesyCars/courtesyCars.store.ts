  ...
  return [
    {
      ...
      createdAt: now,
      updatedAt: now,
      attachments: [seedAttachment("LCZ123", "#2b6cff", "#7ac6ff")],
    },
    {
      id: "car-mkp456",
      plate: "MKP456",
      ...
      agreedValue: 19500,
      status: "on_loan",
      wofExpiry: "2026-06-21",
      regoExpiry: "2026-08-12",
      loanedAt: "2026-06-13T09:15:00.000Z",
      ...
      createdAt: now,
      updatedAt: now,
      attachments: [seedAttachment("MKP456", "#4066f0", "#a3c8ff")],
    },
    {
      id: "car-nqr789",
      plate: "NQR789",
      ...
      regoExpiry: "2026-07-05",
      note: "",
      returnedAt: null,
      createdAt: now,
      updatedAt: now,
      attachments: [seedAttachment("NQR789", "#1d4ed8", "#60a5fa")],
    },
    {
      id: "car-hbd012",
      plate: "HBD012",
      ...
      agreedValue: 27000,
      status: "unavailable",
      wofExpiry: "2026-07-18",
      regoExpiry: "2026-06-20",
      note: "Minor dent repair in progress at panel shop.",
      returnedAt: null,
      createdAt: now,
      updatedAt: now,
      attachments: [
        seedAttachment("HBD012", "#f59e0b", "#fcd34d"),
        {
          id: createId("att"),
          kind: "file",
          name: "repair-note.pdf",
    ...
    },
    {
      ...
      note: "",
      returnedAt: "2026-06-12T08:30:00.000Z",
      createdAt: now,
      updatedAt: now,
      attachments: [seedAttachment("TJF345", "#dc2626", "#f97316")],
    },
  ];
}
