...
{
    public partial class AddCourtesyCarAgreements : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                INSERT INTO courtesy_cars (
                  plate, make, model, color, year, mileage, fuel_level, agreed_vehicle_value, status, note, wof_expiry, rego_expiry, returned_at
                ) VALUES
                  ('LCZ123', 'Toyota', 'Corolla', 'Silver', 2021, 48210, '3/4 tank', 22000, 'available', NULL, '2026-07-10', '2026-07-06', NULL),
                  ('MKP456', 'Honda', 'Civic', 'White', 2020, 56100, 'Half tank', 19500, 'on_loan', NULL, '2026-06-21', '2026-08-12', NULL),
                  ('NQR789', 'Mazda', 'Demio', 'Blue', 2019, 73880, 'Full tank', 15000, 'available', NULL, '2026-05-10', '2026-07-05', NULL),
                  ('HBD012', 'Hyundai', 'i30', 'Black', 2022, 22410, 'Half tank', 27000, 'unavailable', 'Minor dent repair in progress at panel shop.', '2026-07-18', '2026-06-20', NULL),
                  ('TJF345', 'Nissan', 'Tiida', 'Red', 2018, 82215, '1/2 tank', 11000, 'available', NULL, '2026-08-01', '2026-09-11', '2026-06-12 08:30:00+00')
